...
import com.qodeigence.prakash.ecommerce_server_app.Common.DirectionJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try{
                    ...
                    String lat = ((JSONObject)jsonObject.get("results"))
                                    ...
                                    .get("lat").toString();
                    String lng = ((JSONObject)jsonObject.get("results"))
                                    .getJSONObject(String.valueOf(0))
                                    .getJSONObject("geometry")
                                    .getJSONObject("location")
                                    .get("lng").toString();
                    ...
                    mService.getDirections(yourlocation.latitude+","+yourlocation.longitude,
                            ...
                            .enqueue(new Callback<String>() {
                                @Override
                                public void onResponse(Call<String> call, Response<String> response) {
                                    new PrserTask().execute(response.body().toString());
                                }
    ...
    private class PrserTask extends AsyncTask<String,Integer,List<List<HashMap<String,String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> lists) {
            ...
            PolylineOptions lineOpations = null;

            for (int i = 0; i<lists.size(); i++){
                points = new ArrayList();
                lineOpations = new PolylineOptions();
                ...
                lineOpations.addAll(points);
                lineOpations.width(12);
                lineOpations.color(Color.BLUE);
                lineOpations.geodesic(true);
            }
            mMap.addPolyline(lineOpations);
        }
    }
